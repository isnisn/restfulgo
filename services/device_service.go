...
func (service *DeviceService) GetDevice(id int) (*models.Device, error) {
...
func (service *DeviceService) CreateDevice(dev models.Device) (int, error) {
	return service.repo.CreateDevice(dev)
}

func (service *DeviceService) DeleteDevice(id int) error {
	return service.repo.DeleteDevice(id)
}

func (service *DeviceService) PatchDevice(id int, updates map[string]interface{}) error {
